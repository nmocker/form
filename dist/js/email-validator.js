...
var EmailValidator = /*#__PURE__*/function (_Validator) {
  ...
  function EmailValidator(parameters) {
    ...
    _defineProperty(_assertThisInitialized(_this), "validate", function (event) {
      ...
      _get((_thisSuper = _assertThisInitialized(_this), _getPrototypeOf(EmailValidator.prototype)), "validateBefore", _thisSuper).call(_thisSuper, event);
      ...
      _get((_thisSuper2 = _assertThisInitialized(_this), _getPrototypeOf(EmailValidator.prototype)), "validateAfter", _thisSuper2).call(_thisSuper2, event);
    });
