...
var NameValidator = /*#__PURE__*/function (_Validator) {
  ...
  function NameValidator(parameters) {
    ...
    _defineProperty(_assertThisInitialized(_this), "validate", function (event) {
      ...
      _get((_thisSuper = _assertThisInitialized(_this), _getPrototypeOf(NameValidator.prototype)), "validateBefore", _thisSuper).call(_thisSuper, event);
      ...
      _get((_thisSuper2 = _assertThisInitialized(_this), _getPrototypeOf(NameValidator.prototype)), "validateAfter", _thisSuper2).call(_thisSuper2, event);
    });
